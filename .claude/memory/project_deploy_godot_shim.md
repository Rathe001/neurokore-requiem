...
---
**Status:** Bit us in v0.3.0 (2026-05-13) and v0.4.0 (2026-05-15) deploys. The `call` in `deploy.bat:56` was supposed to fix this in v0.3.0 but doesn't actually resolve the issue.
