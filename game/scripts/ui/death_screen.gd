...
const _SNARK_GENERIC: Array[String] = [
	...
	"Heroic. Briefly.",
	"That'll buff out.",
	"Tactical retreat. Permanent edition.",
	"You played, you lost, you'll play again.",
	"Their level was higher than yours.",
	"Not all health bars survive contact with the enemy.",
	"You were promising. Past tense.",
	"Rest in pixels.",
	"That's one way to skip the rest of the level.",
	"Have you tried dying less?",
	"The enemies are taking notes — you're the example.",
	"Strategic horizontal repositioning achieved.",
	"You died as you lived: surrounded.",
	"Numbers go down sometimes.",
	"Statistically, this had to happen eventually.",
	"You ran out of HP. The classic mistake.",
	"Your build needed more ranged. Or melee. Or pants.",
	"Couldn't outpace the math.",
	"The enemies have escaped. Through your corpse.",
	"This is fine. You are fine. (You are not fine.)",
	"Critical existence failure.",
	"Performance review: needs improvement.",
	"You've discovered the floor. Up close.",
	"Press F. Or Continue. Either way, F.",
	"Not the move.",
	"Your hubris has been peer-reviewed.",
	"The dev team is laughing. Sorry.",
]
const _SNARK_PIT: Array[String] = [
	...
	"Speedrun strats. Wrong direction.",
	"Falling damage: still a thing.",
	"You took the express route. Down.",
	"There was a path AROUND that.",
	"Look ma, no platform.",
	"The pit was right there. In the open.",
	"You had one job: not the pit.",
	"Down was the wrong way.",
	"Some say you're still falling.",
]
